                    ...
                    <div class="card-body backpack-profile-form bold-labels">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                ?>
                                <label class="required"><?php echo e($label); ?></label>
                                <input required class="form-control" type="<?php echo e(backpack_authentication_column()==backpack_email_column()?'email':'text'); ?>" name="<?php echo e($field); ?>" value="<?php echo e(old($field) ? old($field) : $user->$field); ?>">
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make(backpack_view('blank'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Learning\Graduation-Project\Website\intelligent-college-timetable-scheduler\intelligent-college-timetable-scheduler(test)\vendor\backpack\crud\src\resources\views\base/my_account.blade.php ENDPATH**/ ?>