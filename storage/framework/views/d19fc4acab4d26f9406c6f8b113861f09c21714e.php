  ...
  <script>
    $(function() {
      $.ajax({
        url: "<?php echo e(route('dashboard.failedStudentsChartData')); ?>",
        type: 'get',
        dataType: 'json',
      ...
      $.ajax({
        url: "<?php echo e(route('dashboard.registeredStudentsChartData')); ?>",
        type: 'get',
        dataType: 'json',
        success: function(response) {
...
<?php echo $__env->make(backpack_view('blank'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Learning\Graduation-Project\Website\intelligent-college-timetable-scheduler\intelligent-college-timetable-scheduler(test)\resources\views/vendor/backpack/base/dashboard.blade.php ENDPATH**/ ?>