      ...
      <div class="card mb-1">
        ...
        <div class="collapse" id="collapseOne" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion" style="">
          <div class="card-body">
            ...
            <p>Go ahead, run it in your terminal. You can now click on the new sidebar item (or <a href="<?php echo e(backpack_url('user')); ?>">here</a>) and you'll be able to see the entries in the <code class="text-primary bg-light p-1 rounded">users</code> table. Even though generated CRUDs work out-of-the-box, they might not be <i>exactly</i> what you need. But that's where Backpack shines, in how easy it is to customize.</p>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\Learning\Graduation-Project\Website\intelligent-college-timetable-scheduler\intelligent-college-timetable-scheduler\vendor\backpack\crud\src\resources\views\base/inc/getting_started.blade.php ENDPATH**/ ?>