...
/**
 * Class HallCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class HallCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Hall::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/hall');
        CRUD::setEntityNameStrings('hall', 'halls');
    }
